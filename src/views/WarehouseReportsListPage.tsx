        ...
        <AppLayout title="Reportes de Almacén">
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-xl font-semibold text-gray-900">Reportes de almacén</h1>
                        <p className="text-sm text-gray-500">
                            Lista de reportes generados (datos de prueba).
                        </p>
                    </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Almacenista</th>
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Quien Recibe</th>
                            ...
                            {mockWarehouseReports.map((report) => (
                                <tr key={report.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <Link href={`/almacen/${report.id}`} className="text-green-600 hover:text-green-900 inline-flex items-center">
