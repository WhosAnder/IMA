...
import { Search, Filter, Plus, FileText, Calendar, User, ArrowRight } from 'lucide-react';
...
export const ReportsListPage: React.FC = () => {
    ...
    if (error) {
        return <div className="p-8 text-center text-red-600">Error al cargar reportes</div>;
    }
        ...
        <AppLayout title="Reportes de Trabajo">
            <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Reportes de Trabajo</h1>
                        <p className="text-gray-500">Gestiona y consulta los reportes de mantenimiento</p>
                    </div>
