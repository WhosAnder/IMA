...
export function WarehouseReportPreview({
  values,
}: WarehouseReportPreviewProps) {
  const {
    subsistema,
    fechaHoraEntrega,
    turno,
          ...
          <div className="relative z-10 h-full w-full flex flex-col bg-transparent">
            ...
            <div className="flex items-center justify-between px-6 pt-5 pb-3">
              <div className="h-10 w-32 flex items-center justify-start">
                ...
                />
                <div
                  className="hidden h-10 w-28 text-white text-xs font-semibold rounded-md flex items-center justify-center"
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <section className="mt-5 px-6">
                <div
                  className="rounded-t-md px-3 py-1 text-[9px] font-semibold uppercase tracking-wide text-white"
                  style={{ backgroundColor: primaryColor }}
                >
                  HERRAMIENTAS QUE SE ENTREGAN
                </div>
                <div
                  className="rounded-b-md border bg-white px-3 py-2 text-[10px] space-y-1"
              ...
              <section className="mt-5 px-6">
                ...
                <div
                  className="min-h-[60px] rounded-b-md border bg-white px-3 py-2 text-[10px] whitespace-pre-wrap"
                  style={{ borderColor: primaryColor, color: primaryColor }}
                >
                  {observacionesGenerales &&
...
function LabeledPill({
  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        className="inline-flex self-start rounded-full px-3 py-1 text-[9px] font-semibold tracking-wide text-white"
        style={{ backgroundColor: color }}
      >
        {label}
      </div>
      <div
        className="min-h-[24px] rounded-full border bg-white px-3 py-1 text-[10px] font-medium"
...
function SignatureBox({
  ...
  return (
    <div>
      <div
        className="rounded-t-md px-2 py-1 text-[8px] font-semibold uppercase tracking-wide text-white text-center"
        style={{ backgroundColor: color }}
      >
        {label}
      </div>
      <div
        className="rounded-b-md border bg-white px-2 py-2 text-[9px] flex flex-col justify-between min-h-[60px]"
        style={{ borderColor: color, color: color }}
      >
