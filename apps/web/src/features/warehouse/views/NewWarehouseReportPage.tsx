    ...
    <div className="max-w-[1600px] mx-auto space-y-8 pb-12 px-4 sm:px-6 lg:px-8">
      <div>
        ...
        <p className="text-gray-500">
          Registro de entrega de herramientas y refacciones.
        </p>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {errors.fechaHoraEntrega && (
                    <p className="mt-1 text-sm text-red-600">
                      {errors.fechaHoraEntrega.message}
                    </p>
                  )}
                </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                      <div className="md:col-span-6">
                        ...
                        />
                        {errors.herramientas?.[index]?.name && (
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm"
                        />
                        {errors.herramientas?.[index]?.units && (
                          <p className="text-xs text-red-500 mt-1">
                            {errors.herramientas[index]?.units?.message}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm"
                        />
                        {errors.refacciones?.[index]?.units && (
                          <p className="text-xs text-red-500 mt-1">
                            {errors.refacciones[index]?.units?.message}
                          </p>
                        )}
                      </div>
                      <div className="md:col-span-4">
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                    {errors.fechaHoraRecepcion && (
                      <p className="mt-1 text-sm text-red-600">
                        {errors.fechaHoraRecepcion.message}
                      </p>
                    )}
                  </div>
                  <div>
                    ...
                    {errors.nombreQuienEntrega && (
                      <p className="mt-1 text-sm text-red-600">
                        {errors.nombreQuienEntrega.message}
                      </p>
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Nombre Almacenista (Cierre)
                    </label>
                    <input
                      type="text"
                    ...
                    />
                    {errors.nombreAlmacenistaCierre && (
                      <p className="mt-1 text-sm text-red-600">
                        {errors.nombreAlmacenistaCierre.message}
                      </p>
                    )}
                  </div>
                </div>
