...
import type { WarehouseReportFormValues } from "@/schema/warehouseReportSchema";

export const mockWarehouseReports: WarehouseReportListItem[] = [
    {
        id: "wh-1",
        folio: "FA-0001",
...
export const mockWarehouseReportDetails: Record<string, WarehouseReportFormValues> = {
    "wh-1": {
        subsistema: "Almacén general",
